...
export function streamNginxShell(req, res) {
  ...
  req.on("close", () => stopNginxShell(sessionId));
  writePromptCommand(child);
}

export function isNginxShellSession(sessionId) {
  return typeof sessionId === "string" && sessionId.startsWith(sessionPrefix);
}

export function writeNginxShellInput(sessionId, input) {
...
export function stopNginxShell(sessionId) {
